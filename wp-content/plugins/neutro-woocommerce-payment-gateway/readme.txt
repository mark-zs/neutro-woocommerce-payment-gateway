...
Neutro is an easy and cheap payment gateway that donates 1% to the environment.

== Description ==

Neutro is free and easy to integrate into e-commerce system. Payments cost just 1%, which goes directly to the planet.
...
Learn more at [neutro.net](https://www.neutro.net/)
Please contact us with any  questions at support@neutro.net
== Installation ==
Before you can use neutro you need to get an API key from https://app.neutro.net/#/merchant/new.
